...
t_basic_flow(Config) ->
  ...
  Index3 = gululog_idx:bump_append(Index0, 3, 50),
  Index  = gululog_idx:bump_append(Index3, 4, 60),
  ?assertEqual({0, 0}, gululog_idx:locate(Index, 0)),
  ?assertEqual({0, 10}, gululog_idx:locate(Index, 1)),
  ?assertEqual({0, 40}, gululog_idx:locate(Index, 2)),
  ?assertEqual({3, 50}, gululog_idx:locate(Index, 3)),
  ?assertEqual({4, 60}, gululog_idx:locate(Index, 4)),
